 ...
 *
 * La bande visée pour les versions premium est de 1/70 à 1/700. Le God Pack
 * reste un événement exceptionnel, distinct de la complétion normale du set.
 *
...
/** Enveloppe totale des arts alternatifs d'une carte, partagée entre ses alts. */
export const ALT_RATE = 0.08;
